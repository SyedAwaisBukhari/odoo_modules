...
class pos_controller(PosController):
        ...
        if (not pos_session and config_id) or k.get('switchPos'):
            try:
                ...
                if not pos_session:
                    ...
                    _logger.info("Another session is already opened for this point of sale.")
    ...
    def dropLicense(self, license='', **k):
        #request.env['ir.config_parameter'].sudo().set_param('license', '11111')
        return json.dumps({
            'code': 200
        })
